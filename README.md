- [Rageit](#rageit)
  ...
  * [Features](#features)
    ...
    + [Homepage:](#homepage-)
    + [Sign Up/Login/Logout Pages:](#sign-up-login-logout-pages-)
    + [Creating A Post:](#creating-a-post-)
    + [Detailed Post Views:](#detailed-post-views-)
...
![Screenshot of omitted coverage files](documentation/coverage-omit.png)
